    ...
    <footer>
      <ConDiv>
        ...
        <ColumDiv>
          ...
          <p>
            <FaCcPaypal /> Payment By Paypal
          </p>
          <p>
            <RiSecurePaymentFill /> Protected Purchase
          </p>
        </ColumDiv>
        <ColumDiv>
          <h4>CONTACT</h4>
          <a href="#">
            <BsTelephoneForward /> +54 1122332233
          </a>
          <a href="#">
            <BiMailSend /> samplemain@emain.com
          </a>
          <a href="#">
            <TfiLocationPin /> Evergreen Terrace 742, Springfield
          </a>
        </ColumDiv>
      </ConDiv>
