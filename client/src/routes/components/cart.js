  ...
  return (
    <Main>
        ...
        {carrito.map((el, index) => (
          <div key={index} className="ProductCard">
            ...
            <div className="InputCartContainer">
              <button
                disabled={el.quantity !== 1 ? false : true}
              ...
              <button
                disabled={el.quantity < el.stock ? false : true}
        ...
        <Total>
          ...
          <h1>
            ...
            {carrito.length >= 1
              ? carrito
                  .reduce(
                    (acc, prod) => acc + prod.price.toFixed(2) * prod.quantity,
                    0
                  )
                  .toFixed(2)
              : null}
      ...
      {carrito.length >= 1 ? (
        <CustomButtons>
        <button
          onClick={() => completePayment(carrito)}
