...
router.get('/brands',async (req, res) => {
    try {
     ...
     const final = brands.filter(el => el !== null).sort()
...
router.get('/types', async (req, res) => {
    try {
        ...
        const final = Type.filter(el => el !== null).sort()
...
router.get('/colors',async (req, res) => {
    try {
        ...
        const final = colors.filter(el => el !== null).sort()
...
router.get('/models',async (req, res) => {
    try {
        ...
        const final = models.filter(el => el !== null).sort()
