...
const { Product, Customer, Order, OrderDetail, Review } = sequelize.models;
...
// reviews
Product.belongsToMany(Customer, { through: Review })
Customer.belongsToMany(Product, { through: Review })
